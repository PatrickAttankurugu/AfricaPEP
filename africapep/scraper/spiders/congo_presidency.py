...
class CongoPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Anatole Collinet Makosso", "role": "Prime Minister"},
            {"name": "Jean-Claude Gakosso", "role": "Minister of Foreign Affairs"},
            {"name": "Raymond Zéphirin Mboulou", "role": "Minister of Interior"},
            {"name": "Rigobert Roger Andely", "role": "Minister of Finance"},
            {"name": "Charles Richard Mondjo", "role": "Minister of Defence"},
            {"name": "Aimé Ange Wilfrid Bininga", "role": "Minister of Justice"},
            {"name": "Gilbert Mokoki", "role": "Minister of Health"},
            {"name": "Jean-Luc Mouthou", "role": "Minister of Education"},
            {"name": "Bruno Jean Richard Itoua", "role": "Minister of Hydrocarbons"},
            {"name": "Paul Valentin Ngobo", "role": "Minister of Agriculture"},
            {"name": "Isidore Mvouba", "role": "Speaker of National Assembly"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
