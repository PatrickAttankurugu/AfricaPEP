...
class BeninPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Abdoulaye Bio Tchané", "role": "Minister of State for Development"},
            {"name": "Romuald Wadagni", "role": "Minister of Economy and Finance"},
            {"name": "Yvon Detchenou", "role": "Minister of Justice"},
            {"name": "Olushegun Adjadi Bakari", "role": "Minister of Foreign Affairs"},
            {"name": "Alassane Seidou", "role": "Minister of Interior"},
            {"name": "Benjamin Hounkpatin", "role": "Minister of Health"},
            {"name": "Salimane Karimou", "role": "Minister of Education"},
            {"name": "Shadiya Alimatou Assouman", "role": "Minister of Industry and Commerce"},
            {"name": "Gaston Dossouhoui", "role": "Minister of Agriculture"},
            {"name": "Aurelie Soule Zoumarou", "role": "Minister of Digital"},
