...
class SaoTomePresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Gareth Guadalupe", "role": "Minister of Foreign Affairs"},
            {"name": "Jorge Lopes Bom Jesus", "role": "Minister of Internal Administration"},
            {"name": "Engracia Barros da Graça", "role": "Minister of Finance"},
            {"name": "Óscar Sousa", "role": "Minister of Defence"},
            {"name": "Ilza Amado Vaz", "role": "Minister of Justice"},
            {"name": "Edgar Neves", "role": "Minister of Health"},
            {"name": "Julieta Izidro Rodrigues", "role": "Minister of Education"},
            {"name": "Teodorico de Campos", "role": "Minister of Agriculture"},
            {"name": "Américo Barros", "role": "Minister of Infrastructure"},
            {"name": "Frederico Carvalho dos Santos", "role": "Minister of Planning"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
