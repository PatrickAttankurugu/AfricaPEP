...
class AngolaPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Francisco Tavares de Almeida", "role": "Minister of Defence"},
            ...
            {"name": "Luísa Grilo", "role": "Minister of Higher Education"},
            {"name": "Diamantino Azevedo", "role": "Minister of Mineral Resources and Petroleum"},
            {"name": "António Francisco de Assis", "role": "Minister of Agriculture and Fisheries"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
