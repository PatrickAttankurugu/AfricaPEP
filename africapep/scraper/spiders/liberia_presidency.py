...
class LiberiaPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Augustine Kpehe Ngafuan", "role": "Minister of Finance and Development Planning"},
            {"name": "Prince Ceasar Johnson", "role": "Minister of National Defence"},
            {"name": "N. Oswald Tweh", "role": "Attorney General and Minister of Justice"},
            ...
            {"name": "Yanqui Zaza", "role": "Minister of Commerce and Industry"},
            {"name": "Bhofal Chambers", "role": "Speaker of the House of Representatives"},
            {"name": "Nya Flomo", "role": "Minister of Gender, Children and Social Protection"},
            {"name": "George K. Werner", "role": "Minister of Public Works"},
            {"name": "Nwabudike Laveli", "role": "Minister of Labour"},
            {"name": "Mamaka Bility", "role": "Minister of Youth and Sports"},
            {"name": "Sylvester Grigsby", "role": "Minister of Information, Cultural Affairs and Tourism"},
            {"name": "Emmanuel Nuquay", "role": "Minister of Transport"},
            {"name": "Thomas Doe Nah", "role": "Auditor General"},
            {"name": "Fonati Koffa", "role": "Deputy Speaker of the House of Representatives"},
            {"name": "Nyonblee Karnga-Lawrence", "role": "President Pro Tempore of the Senate"},
            {"name": "Sie-A-Nyene Yuoh", "role": "Chief Justice of Liberia"},
            {"name": "J. Aloysius Tarlue Jr.", "role": "Governor, Central Bank of Liberia"},
            {"name": "Major General Prince C. Johnson III", "role": "Chief of Staff, Armed Forces of Liberia"},
            {"name": "George Weah", "role": "Former President of the Republic"},
            {"name": "Ellen Johnson Sirleaf", "role": "Former President of the Republic"},
            {"name": "Alexander Cummings", "role": "Opposition Leader, ANC"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
