...
class GuineaPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        now = datetime.utcnow()
        officials = [
            {"name": "Mamadi Doumbouya", "role": "President of the Transition"},
            {"name": "Amadou Oury Bah", "role": "Prime Minister"},
            {"name": "Morissanda Kouyaté", "role": "Minister of Foreign Affairs"},
            {"name": "Bachir Diallo", "role": "Minister of Interior"},
            {"name": "Mourana Soumah", "role": "Minister of Economy and Finance"},
            {"name": "Aboubacar Sidiki Camara", "role": "Minister of Defence"},
            {"name": "Alphonse Charles Wright", "role": "Minister of Justice"},
            {"name": "Oumar Maleya Camara", "role": "Minister of Health"},
            {"name": "Jean Paul Cedy", "role": "Minister of Education"},
            {"name": "Fana Soumah", "role": "Minister of Communication"},
            {"name": "Mamadou Oury Bah", "role": "Minister of Agriculture"},
