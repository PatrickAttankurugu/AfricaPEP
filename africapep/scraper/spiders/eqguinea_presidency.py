...
class EqGuineaPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Simeón Oyono Esono Angue", "role": "Minister of Foreign Affairs"},
            {"name": "Nicolás Obama Nchama", "role": "Minister of Interior"},
            {"name": "Valentin Ela Maye", "role": "Minister of Finance"},
            {"name": "Teodoro Nguema Obiang Mangue", "role": "Vice President"},
            {"name": "Evangelina Filomena Oyo Ebule", "role": "Minister of Justice"},
            {"name": "Mitoha Ondo'o Ayekaba", "role": "Minister of Health"},
            {"name": "Jesús Engonga Ndong", "role": "Minister of Education"},
            {"name": "Gabriel Mbega Obiang Lima", "role": "Minister of Mines and Hydrocarbons"},
            {"name": "Diosdado Vicente Nsue Milang", "role": "Minister of Defence"},
            {"name": "Clemente Engonga Nguema Onguene", "role": "Speaker of Senate"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
