...
class GuineaBissauPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        ...
        officials = [
            ...
            {"name": "Suzi Barbosa", "role": "Minister of Foreign Affairs"},
            {"name": "Botche Candé", "role": "Minister of Interior"},
            {"name": "Ilídio Vieira", "role": "Minister of Finance"},
            {"name": "Sandji Fati", "role": "Minister of Defence"},
            {"name": "Mamadu Iaia Djaló", "role": "Minister of Justice"},
            {"name": "Dionísio Cabi", "role": "Minister of Health"},
            {"name": "Satu Camará", "role": "Minister of Education"},
            {"name": "Fernando Vaz", "role": "Minister of Agriculture"},
            {"name": "Marciano Silva Barbeiro", "role": "Minister of Energy"},
            {"name": "Domingos Simões Pereira", "role": "Leader of PAIGC"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
