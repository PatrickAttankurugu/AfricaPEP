...
class MauritaniaPresidencyScraper(BaseScraper):
    ...
    def _synthetic_fixture(self) -> list[RawPersonRecord]:
        now = datetime.utcnow()
        officials = [
            {"name": "Mohamed Ould Ghazouani", "role": "President of the Republic"},
            {"name": "Mohamed Ould Bilal", "role": "Prime Minister"},
            {"name": "Mohamed Salem Ould Merzoug", "role": "Minister of Foreign Affairs"},
            {"name": "Mohamed Ahmed Ould Mohamed Lemine", "role": "Minister of Interior"},
            ...
            {"name": "Mohamed Melainine Ould Eyih", "role": "Minister of Education"},
            {"name": "Dy Ould Zein", "role": "Minister of Agriculture"},
            {"name": "Abdessalam Ould Mohamed Saleh", "role": "Minister of Petroleum"},
            {"name": "Naha Mint Mouknass", "role": "Minister of Foreign Affairs (Former)"},
        ]
        records = []
        for o in officials:
            records.append(RawPersonRecord(
